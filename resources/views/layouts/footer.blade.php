<div class="footer">
        ...
        <div class="left-footer-common">
            ...
            <div class="useful-links-footer">
                ...
                <ul class="footer-useful-links">
                    ...
                    <li class="">
                        <a>Ứng dụng Di động Miễn phí</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="right-footer-common">
            <a class="instagram">
                <svg role="img" height="16" width="16" aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon" class="Svg-sc-ytk21e-0 hOjEcl">
    ...
    <span style=" display : flex;color: #fff; margin-top : 24px; margin-bottom : 20px;">
        © 2024 Spotify AB
    </span>
</div>